			...
			try {
				...
				if (MyTags != null && MyTags.length > 0) {
					for (int i = 0; i < MyTags.length; i++)
					{
						...
						byte[] DataToRead;
						DataToRead = source.ReadTagData_EPC_C1G2(MyTags[i], (short)3, (short)34, (short)2);
						...
						DataToRead = source.ReadTagData_EPC_C1G2(MyTags[i], (short)3, (short)30, (short)4);
						String tid = new Date(Long.parseLong(Caenrfid.toHexString(DataToRead), 16)*1000).toString();
						resultString += "Start time: "+tid+"\n";
						...
						source.WriteTagData_EPC_C1G2(MyTags[i], (short)3, (short)28, (short)2, DataToWrite);
						//Set sampling
				//		DataToWrite = hexStringToByteArray("0708");
						DataToWrite = hexStringToByteArray("0008");
						source.WriteTagData_EPC_C1G2(MyTags[i], (short)3, (short)36, (short)2, DataToWrite);
						
						//Read sampling
						DataToRead = source.ReadTagData_EPC_C1G2(MyTags[i], (short)3, (short)36, (short)2);
						...
						source.WriteTagData_EPC_C1G2(MyTags[i], (short)3, (short)30, (short)4, DataToWrite);

						DataToWrite = hexStringToByteArray("03c0");
						source.WriteTagData_EPC_C1G2(MyTags[i], (short)3, (short)28, (short)2, DataToWrite);
						Log.d("caenrfid","tag written");
						DataToRead = source.ReadTagData_EPC_C1G2(MyTags[i], (short)3, (short)28, (short)2);
						Log.d("caenrfid","Tag read, value = " + Caenrfid.toHexString(DataToRead));
					}
				}
			} catch (CAENRFIDException e) {
...
//				CAENRFIDTag[] MyTags = source.InventoryTag();
				...
				if (MyTags != null && MyTags.length > 0) {
					...
					for (int i = 0; i < MyTags.length; i++)
					{
						...
						byte[] DataToRead;
						count = 10;
						while ((DataToRead = source.ReadTagData_EPC_C1G2(MyTags[i], (short)3, (short) 34, (short) 2)) == null && count>10) {
							Log.d("caenrfid","datatoread "+Caenrfid.toHexString(DataToRead));
							count--;
							Log.d("caenrfid","once more");
						}
						...
						for (int sampNum=0; sampNum < Math.round(samples/4) ; sampNum++) {
							DataToRead = source.ReadTagData_EPC_C1G2(MyTags[i], (short)3, (short)(46+(8*sampNum)), (short)8);
